      ...
      {selectedRole === "parent" ? (
        ...
        <div className="space-y-12">
          ...
          <div className="text-center lg:text-left space-y-4">
            <h2 className="text-xs font-mono tracking-widest text-emerald-400 uppercase font-bold bg-emerald-500/10 border border-emerald-500/20 px-3 py-1 rounded-full w-fit mx-auto lg:mx-0 shadow-[0_0_15px_rgba(16,185,129,0.05)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div variants={cardVariants} className="glass-card p-6 rounded-2xl border border-slate-800 bg-slate-900/40 relative overflow-hidden group sm:col-span-2 lg:col-span-1">
              ...
              <div className="text-xs text-slate-400 mt-2 font-mono">Dhaka North & South sectors matched</div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <motion.div variants={cardVariants} className="glass-card p-8 rounded-3xl border border-slate-800 bg-slate-950/40 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  We enforce an advanced verification system to secure parent safety. When matching a tutor, make sure to take advantage of these protocols:
                </p>
                <ul className="space-y-3 pt-2 text-xs sm:text-sm text-slate-300 font-sans">
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2.5">✓</span>
                    <span><strong>NID Cross-Check:</strong> Every tutor has their National Identity verified by admins side-by-side using zoom lightboxes.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2.5">✓</span>
                    <span><strong>Academic Shield:</strong> Real-time OCR scanning blocks blank, fake, or landscape credentials immediately on registration.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-400 mr-2.5">✓</span>
                    <span><strong>First Free Lesson:</strong> We recommend conducting an initial interview or trial session in public spaces or under supervision.</span>
                  </li>
                </ul>
              </div>
            ...
            <motion.div variants={cardVariants} className="glass-card p-8 rounded-3xl border border-slate-800 bg-slate-950/40 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  We've streamlined parent match workflows to secure matching in minutes:
                </p>
                <div className="space-y-4 font-sans text-slate-300 pt-2">
                  <div className="flex gap-4">
                    ...
                    <div className="text-xs sm:text-sm">
                      <strong>Locate Nearby Tutors:</strong> Open the filtered search map and filter profiles by institution, class level, or hourly budget.
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div className="text-xs sm:text-sm">
                      <strong>Initiate Link Request:</strong> Request a secure link with a tutor. Once they accept your tuition requirements, coordinates open.
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div className="text-xs sm:text-sm">
                      <strong>Verify & Engage:</strong> Run final IDLightbox checks on their credentials inside your dashboard and coordinate classes securely.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-12">
          {/* Header */}
          <div className="text-center lg:text-left space-y-4">
            <h2 className="text-xs font-mono tracking-widest text-indigo-400 uppercase font-bold bg-indigo-500/10 border border-indigo-500/20 px-3 py-1 rounded-full w-fit mx-auto lg:mx-0 shadow-[0_0_15px_rgba(99,102,241,0.05)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <motion.div variants={cardVariants} className="glass-card p-6 rounded-2xl border border-slate-800 bg-slate-900/40 relative overflow-hidden group">
              ...
              <div className="text-xs text-slate-400 mt-2 font-mono">Located in Dhaka North & South sectors</div>
            </motion.div>
            ...
            <motion.div variants={cardVariants} className="glass-card p-6 rounded-2xl border border-slate-800 bg-slate-900/40 relative overflow-hidden group">
              ...
              <div className="text-xs text-slate-400 mt-2 font-mono">Secured by premium parents in Dhaka</div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
            ...
            <motion.div variants={cardVariants} className="glass-card p-8 rounded-3xl border border-slate-800 bg-slate-950/40 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Parents prioritize verified educators. When you register, our client-side OCR engine scans your uploads to ensure authenticity:
                </p>
                <div className="space-y-4 font-sans text-slate-300 pt-2">
                  <div className="flex gap-4">
                    ...
                    <div className="text-xs sm:text-sm">
                      <strong>NID Scan:</strong> Real-time checks extract keywords like "bangladesh", "national", "identity" to ensure a valid NID is uploaded.
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 font-mono text-xs flex items-center justify-center font-bold">✓</div>
                    <div className="text-xs sm:text-sm">
                      <strong>Student ID Check:</strong> Scans for keywords like "student", "id", "university" to verify you've provided active university proof.
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div className="text-xs sm:text-sm">
                      <strong>Anti-Fake Block:</strong> Blank uploads, landscapes, or irrelevant pictures are instantly flagged and blocked before using Vercel storage bandwidth.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <motion.div variants={cardVariants} className="glass-card p-8 rounded-3xl border border-slate-800 bg-slate-950/40 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Earn supplementary income by sharing academic skills. Build a professional reputation following this workflow:
                </p>
                <ul className="space-y-3 pt-2 text-xs sm:text-sm text-slate-300 font-sans">
                  <li className="flex items-start">
                    <span className="text-indigo-400 mr-2.5">→</span>
                    <span><strong>1. Create Verified Identity:</strong> Register your credentials. Once active, your profile gains a verified badge in search results.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo-400 mr-2.5">→</span>
                    <span><strong>2. Explore Spatial Vacancies:</strong> Open our responsive interactive map and browse parent job locations in Banani, Dhanmondi, etc.</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-indigo-400 mr-2.5">→</span>
                    <span><strong>3. Match & Secure Details:</strong> Apply to parent requests. Commission fees are secured through a seamless, simulated bKash checkout page.</span>
                  </li>
                </ul>
              </div>
              <div className="pt-4">
                <Link href="/map" className="text-indigo-400 hover:text-indigo-300 font-mono text-xs flex items-center space-x-1.5 transition">
